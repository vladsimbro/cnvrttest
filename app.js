(function(){
  const APP_VERSION = window.APP_VERSION || '1.2.27';
...
function buildTreePayload(){
      const token = (treeToken && treeToken.value !== undefined && treeToken.value !== null && treeToken.value !== '') ? String(treeToken.value) : 'secret_access_token';
